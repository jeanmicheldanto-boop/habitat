/**
 * Script pour supprimer l'établissement Résidence Saint Louis
 * Email: rsl@residencesaintlouis.org
 */
...
async function deleteSaintLouis() {
  console.log('\n🗑️  SUPPRESSION RÉSIDENCE SAINT LOUIS\n');
